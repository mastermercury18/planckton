...
export declare function createMessage<T extends IClearOutputMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommCloseMsg<'iopub'>>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommCloseMsg<'shell'>>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommInfoReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommInfoRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommMsgMsg<'iopub'>>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommMsgMsg<'shell'>>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommOpenMsg<'iopub'>>(options: IOptions<T>): T;
export declare function createMessage<T extends ICommOpenMsg<'shell'>>(options: IOptions<T>): T;
export declare function createMessage<T extends ICompleteReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends ICompleteRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IDisplayDataMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IErrorMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IExecuteInputMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IExecuteReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IExecuteRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IExecuteResultMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IHistoryReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IHistoryRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInfoReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInfoRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInputReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInputRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInspectReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInspectRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInterruptReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IInterruptRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IIsCompleteReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IIsCompleteRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IStatusMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IStreamMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IUpdateDisplayDataMsg>(options: IOptions<T>): T;
/**
 * @hidden
 * #### Notes
 ...
 */
export declare function createMessage<T extends IDebugRequestMsg>(options: IOptions<T>): T;
/**
 * @hidden
 * #### Notes
 * Debug messages are experimental messages that are not in the official
 ...
 * part of the public API, and may change without notice.
 */
export declare function createMessage<T extends IDebugReplyMsg>(options: IOptions<T>): T;
/**
 * @hidden
 * #### Notes
 * Debug messages are experimental messages that are not in the official
 ...
 * part of the public API, and may change without notice.
 */
export declare function createMessage<T extends IDebugEventMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends ICreateSubshellRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends ICreateSubshellReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IDeleteSubshellRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IDeleteSubshellReplyMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IListSubshellRequestMsg>(options: IOptions<T>): T;
export declare function createMessage<T extends IListSubshellReplyMsg>(options: IOptions<T>): T;
/**
 * Shell message types.
 */
export type ShellMessageType = 'comm_close' | 'comm_info_reply' | 'comm_info_request' | 'comm_msg' | 'comm_open' | 'complete_reply' | 'complete_request' | 'execute_reply' | 'execute_request' | 'history_reply' | 'history_request' | 'inspect_reply' | 'inspect_request' | 'is_complete_reply' | 'is_complete_request' | 'kernel_info_reply' | 'kernel_info_request' | 'shutdown_reply' | 'shutdown_request';
/**
 ...
 */
export type ControlMessageType = 'interrupt_reply' | 'interrupt_request' | 'debug_request' | 'debug_reply' | 'create_subshell_request' | 'create_subshell_reply' | 'delete_subshell_request' | 'delete_subshell_reply' | 'list_subshell_request' | 'list_subshell_reply';
/**
 * IOPub message types.
 *
 * #### Notes
