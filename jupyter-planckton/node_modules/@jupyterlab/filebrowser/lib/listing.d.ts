...
export declare class DirListing extends Widget {
    ...
    private _columnSizes;
    private _sortNotebooksFirst;
    private _allowSingleClick;
    private _focusIndex;
    private _modifiedWidth;
    private _modifiedStyle;
    private _allUploaded;
    private _width;
    private _state;
    private _contentScrollbarWidth;
    private _contentSizeObserver;
...
export declare namespace DirListing {
     ...
     */
    export type IColumn = IFixedColumn | ISortableColumn | IResizableColumn | (ISortableColumn & IResizableColumn);
    /**
     * Column definitions.
     */
 ...
 */
export declare function formatFileSize(bytes: number, decimalPoint: number, k: number): string;
