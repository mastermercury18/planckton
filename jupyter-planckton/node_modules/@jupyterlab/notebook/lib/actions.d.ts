...
export declare namespace NotebookActions {
     ...
     * @param notebook - The target notebook widget.
     */
    function copyToSystemClipboard(notebook: Notebook): Promise<void>;
    /**
     ...
     * A new code cell is added if all cells are cut.
     */
    function cutToSystemClipboard(notebook: Notebook): Promise<void>;
    /**
     ...
     * This action can be undone.
     */
    function pasteFromSystemClipboard(notebook: Notebook, mode?: 'below' | 'belowSelected' | 'above' | 'replace'): Promise<void>;
    /**
