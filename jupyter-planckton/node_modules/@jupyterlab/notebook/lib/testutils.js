...
import { Clipboard, SessionContextDialogs, SystemClipboard } from '@jupyterlab/apputils';
...
(function (NBTestUtils) {
        ...
        extensions.addExtension({
            ...
            factory: ({ model }) => {
                ...
                return EditorExtensionRegistry.createImmutableExtension(ybinding({
                    ytext: model.sharedModel.ysource,
                    undoManager: (_a = model.sharedModel.undoManager) !== null && _a !== void 0 ? _a : undefined
                }));
            }
        });
    ...
    NBTestUtils.systemClipboard = SystemClipboard.getInstance();
    /**
